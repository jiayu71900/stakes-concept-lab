...
export const challengeMessages: ChallengeMessage[] = [
  ...
  { id: "challenger-steam-6", challengeId: "steam-deck", authorId: "past-challenger-lena", authorName: "Lena", day: 6, body: "The ugly first build made me believe this might actually happen.", kind: "CHALLENGER_NOTE" },
  { id: "challenger-steam-23", challengeId: "steam-deck", authorId: "past-challenger-omar", authorName: "Omar", day: 23, body: "Cut multiplayer. I want to lose this bet, not watch the scope win.", kind: "CHALLENGER_NOTE" },
  ...
  { id: "challenger-startup-12", challengeId: "startup", authorId: "past-challenger-iris", authorName: "Iris", day: 12, body: "Four customers is no longer a landing page. Keep going.", kind: "CHALLENGER_NOTE" },
